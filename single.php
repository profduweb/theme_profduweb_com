                ...
                <header class="entry-header">
                    <div class="article-navigation-bar">
                        ...
                        <div class="social-share-minimal">
                            ...
                            <a href="https://threads.net/intent/post?text=<?php echo urlencode(get_the_title() . ' ' . get_permalink()); ?>"
                            ...
                            <a href="https://bsky.app/intent/compose?text=<?php echo urlencode(get_the_title() . ' ' . get_permalink()); ?>"
